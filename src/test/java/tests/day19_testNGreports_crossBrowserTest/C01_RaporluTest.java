...
public class C01_RaporluTest extends TestBaseRapor {
    ...
    public void nutellaTesti(){
        extentTest = extentReports.createTest("Amazon Arama Testi","Kullanici amazon'da istenen kelimeyi aratip ilk ürüne gitmeli");
        ...
        extentTest.pass("Amazon aranan sonuclerinin aranan kelimeyi icerdigini test eder");
